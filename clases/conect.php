...
$conex=new conect();
// $conex->dbconect("104.131.191.252","user_optiventas","TJWmj3mpaaS8cjvT","demo");
$conex->dbconect('localhost','root','12345678','bdopticenter1');
// $conex->dbconect('209.217.245.186','delnorte_opfabio','f+159753','delnorte_opccenter');
?>